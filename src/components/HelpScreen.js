...
function HelpScreen(props) {
  ...
  const lastIndex = config.sections.helpScreen.helpContent.length - 1;
  const firstIndex = 0;
  ...
  return (
    <div className="screen-container helpscreen-container">
      ...
      <div className="help-elements">
        <h2>{config.sections.helpScreen.heading}</h2>
